...
const homepageData = {
  heroSection: {
    th: {
      ...
      secondaryButtonText: 'รู้จัก Logix',
      secondaryButtonLink: '/products/logix',
      trustedByText: 'ได้รับความไว้วางใจจากองค์กรชั้นนำ',
      stats: [
        { value: '20+', label: 'องค์กรที่ไว้วางใจ' },
        { value: '6', label: 'สาขาความเชี่ยวชาญ' },
        { value: '2024', label: 'ก่อตั้ง' },
        { value: 'เชียงใหม่', label: 'ฐานที่ตั้ง' },
      ],
      partners: [
        { name: 'Proxmox', note: 'ตัวแทนจำหน่าย' },
        { name: 'Dell' },
        { name: 'Google Cloud' },
      ],
    },
    en: {
      ...
      secondaryButtonText: 'Discover Logix',
      secondaryButtonLink: '/products/logix',
      trustedByText: 'Trusted by leading organizations',
      stats: [
        { value: '20+', label: 'Organizations served' },
        { value: '6', label: 'Solution pillars' },
        { value: '2024', label: 'Founded' },
        { value: 'Chiang Mai', label: 'Based in' },
      ],
      partners: [
        { name: 'Proxmox', note: 'Authorized Reseller' },
        { name: 'Dell' },
        { name: 'Google Cloud' },
      ],
    },
