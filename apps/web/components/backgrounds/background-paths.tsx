...
export function BackgroundPaths({ className = '' }: BackgroundPathsProps) {
  return (
    <div className={`absolute inset-0 overflow-hidden ${className}`}>
      ...
      <motion.div
        className="absolute -bottom-[30%] -right-[10%] w-[700px] h-[700px] rounded-full"
        style={{
      ...
      {/* Glowing accent ring */}
      <motion.div
        className="absolute top-[20%] left-[60%] w-[200px] h-[200px] rounded-full border-2 border-primary/20"
        style={{
      ...
      <motion.div
        className="absolute bottom-[25%] left-[10%] w-[150px] h-[150px] rounded-full border border-primary/15"
        style={{
