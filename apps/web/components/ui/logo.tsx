            ...
            {animated ? (
              <>
                ...
                <motion.path
                  ...
                  style={{ filter: 'drop-shadow(0 0 6px #6EE5C9)' }}
                />
                <motion.path
                  d={bracketPath}
                  stroke="#38D2AF"
                  ...
                  transition={{ duration: 1.2, ease: 'linear', delay: 0.4 }}
                  style={{ filter: 'drop-shadow(0 0 6px #38D2AF)' }}
                />
                <motion.path
                  d={bracketPath}
                  stroke="#16C79A"
                  ...
                  transition={{ duration: 1.2, ease: 'linear', delay: 0.4 }}
                  style={{ filter: 'drop-shadow(0 0 8px #16C79A)' }}
                />
                {/* Final bracket */}
                <motion.path
                  d={bracketPath}
      ...
      {showTagline && (
        animated ? (
          <motion.span
            ...
            style={{
              background: 'linear-gradient(90deg, #16C79A 0%, #16C79A 45%, oklch(var(--bc)) 55%, oklch(var(--bc)) 100%)',
